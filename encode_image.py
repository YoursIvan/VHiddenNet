...
def main():
    ...
    parser.add_argument('--stego_name', type=str, default=None)
    ...
    if len(args.secret) > 11:
        print('Error: Can only encode 288bits (36 characters) with ECC')
        return

    data = bytearray(args.secret + ' '*( 11-len(args.secret)), 'utf-8')
    ecc = bch.encode(data)
    packet = data + ecc
    ...
    if args.save_dir is not None:
        ...
        for filename in files_list:
            ...
            im.save(args.save_dir + '/'+args.stego_name,quality = 80)
